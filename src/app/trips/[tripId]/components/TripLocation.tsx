    ...
    return (
        <div className="p-5 lg:p-0 lg:mt-12 lg:pb-20">
            ...
            <div className="relative h-[280px] w-full lg:hidden">
                <Image style={{ objectFit: 'cover' }} fill src="/map-mobile.png" alt={location} className="shadow-md rounded-lg" />
            </div>
            ...
            <p className="text-xs text-primaryDarker mt-5 leading-5 lg:text-sm lg:mt-4">{locationDescription}</p>
